...
<nav class="navbar">
    <div class="container-fluid">
      ...
      <form class="d-flex" role="logout">
        <a href=""><button class="btn logout" method='get'>Log out</button></a>
      </form>
    </div>
  </nav>
...
<div class="container-view-posts">
    ...
    <div class="container-view-posts2">
      <h6><?php echo e($post->username); ?></h6>
      <p><?php echo e($post->konten); ?></p>
       <div class="reactions">
        <button class="btn-comment" method='get'><img src="<?php echo e(asset("img/comment-btn.png")); ?>" alt=""><span>777</span></button>
        <button class="btn-upvote" method='get'><img src="<?php echo e(asset("img/upvote-btn-removebg-preview.png")); ?>" alt=""><span>123</span></button>
      </div>
    </div>
  </div>
