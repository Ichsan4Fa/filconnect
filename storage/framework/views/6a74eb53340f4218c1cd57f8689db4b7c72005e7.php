...
<div class="container-view-posts">
    ...
    <div class="container-view-posts2">
      ...
      <video controls autoplay loop>
        <source src="<?php echo e($post->video); ?>">
      </video><br>
      <img class="content-image" src="<?php echo e($post->foto); ?>" alt="content-image">
      <p><?php echo e($post->konten); ?></p>
      <p><?php echo e($post->created_at); ?></p>
       <div class="reactions">
        <button class="btn-comment"><img src="<?php echo e(asset("img/comment-btn.png")); ?>" alt=""><span>777</span></button>
        <button class="btn-upvote"><img src="<?php echo e(asset("img/upvote-btn-removebg-preview.png")); ?>" alt=""><span><?php echo e($upvote->jumlahKomentar->count()); ?></span></button>
      </div>
    </div>
  </div>
  ...
  <div class="view-comments">
    ...
    <div class="container-view-comments2">
      <h6>User<?php echo e($comment->student_id); ?></h6>
      <p><?php echo e($comment->komentar); ?></p>
    </div>
  </div>    
